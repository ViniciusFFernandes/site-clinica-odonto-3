...
$ldjson = json_encode([
  ...
  '@graph' => [[
    ...
    'address' => [
      '@type' => 'PostalAddress',
      'streetAddress' => 'Rua Exemplo, 000, 1º Andar - Centro',
...
<body class="min-h-screen bg-background font-sans text-foreground antialiased">
  ...
  <main id="topo">
    ...
    <section class="relative overflow-hidden" style="background: var(--gradient-deep)">
      <div aria-hidden="true" class="pointer-events-none absolute -top-32 -right-24 size-[40rem] rounded-full bg-emerald/10 blur-3xl"></div>
      <div aria-hidden="true" class="pointer-events-none absolute -bottom-40 -left-32 size-[34rem] rounded-full bg-petrol/40 blur-3xl"></div>
      <div aria-hidden="true" class="pointer-events-none absolute inset-0 opacity-[0.06]" style="background-image: radial-gradient(circle at 1px 1px, #fff 1px, transparent 0); background-size: 34px 34px;"></div>
      ...
      <div class="relative mx-auto grid max-w-7xl items-center gap-12 px-5 pt-36 pb-20 lg:grid-cols-12 lg:gap-8 lg:px-8 lg:pt-44 lg:pb-28">
        <div class="reveal lg:col-span-6">
          <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-semibold tracking-wide text-emerald uppercase backdrop-blur">
            <span class="relative flex size-2">
              <span class="absolute inline-flex size-full animate-ping rounded-full bg-emerald opacity-75"></span>
              <span class="relative inline-flex size-2 rounded-full bg-emerald"></span>
            </span>
            Dentista em Centro · Cidade Exemplo
          </span>

          <h1 class="mt-7 font-display text-4xl leading-[1.05] font-700 tracking-tight text-white text-balance sm:text-5xl lg:text-6xl">
            <?= e($cfg['hero_titulo_1']) ?> <span class="text-emerald"><?= e($cfg['hero_titulo_2']) ?></span>
          </h1>
          ...
          <div class="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="<?= e($waLink) ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 rounded-full bg-accent px-7 py-4 text-base font-semibold text-accent-foreground shadow-[var(--shadow-lift)] transition-transform hover:scale-[1.03]">
              <?= icon('clipboard-check', 'size-5') ?>Agendar Avaliação
            </a>
            <a href="#especialidades" class="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-7 py-4 text-base font-semibold text-white backdrop-blur transition-colors hover:bg-white/10">
          ...
          <div class="mt-10 inline-flex items-center gap-4 rounded-2xl border border-white/12 bg-white/5 px-5 py-4 backdrop-blur">
            <div class="text-center">
              <div class="font-display text-3xl font-700 leading-none text-white"><?= e($cfg['rating']) ?></div>
              <div class="mt-1 flex gap-0.5 text-emerald"><?php for($k=0;$k<5;$k++) echo icon('star','size-3.5 fill-emerald'); ?></div>
            </div>
            <div class="h-10 w-px bg-white/15"></div>
            <div class="text-sm leading-snug text-white/70">
              <div class="font-semibold text-white">Nota 5.0 no Google</div>
        ...
        <div class="reveal relative lg:col-span-6 lg:pl-10" style="transition-delay:140ms">
          <div class="relative">
            <div class="overflow-hidden rounded-[2.5rem] border border-white/10 shadow-[var(--shadow-lift)]">
              <img src="img/hero-clinica.svg" alt="Atendimento odontológico de alto padrão na Clínica Odontológica Modelo" width="1000" height="1150" class="h-full w-full object-cover" />
            </div>
            <div class="absolute -bottom-6 -left-4 flex items-center gap-3 rounded-2xl border border-border bg-background/95 px-5 py-4 shadow-[var(--shadow-lift)] backdrop-blur sm:-left-8">
              <span class="grid size-11 shrink-0 place-items-center rounded-xl text-accent-foreground" style="background: var(--gradient-emerald)"><?= icon('anchor', 'size-5') ?></span>
              <span class="min-w-0">
                <span class="block text-sm font-semibold text-primary">Especialistas em Implantes</span>
                <span class="block text-xs text-muted-foreground">Implantodontia & Periodontia</span>
              </span>
            </div>
      ...
      <a href="#diferenciais" class="relative mx-auto mb-8 hidden w-fit items-center gap-2 px-8 text-xs font-medium tracking-widest text-white/50 uppercase transition-colors hover:text-emerald lg:flex">
    ...
    <section id="diferenciais" class="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
      <div class="grid gap-8 lg:grid-cols-12 lg:items-end">
        <div class="reveal lg:col-span-5">
          ...
          <h2 class="mt-4 font-display text-4xl font-700 tracking-tight text-primary text-balance sm:text-5xl">Por que escolher a Odonto Modelo</h2>
        </div>
          ...
          <div class="reveal bg-card" style="transition-delay:<?= ($i % 3) * 80 ?>ms">
            <article class="group flex h-full flex-col gap-5 p-8 transition-colors hover:bg-secondary/50 lg:p-10">
              <div class="flex items-center justify-between">
                ...
                <span class="font-display text-4xl font-600 text-secondary"><?= sprintf('%02d', $i + 1) ?></span>
              </div>
              <div>
    ...
    <section id="especialidades" class="relative overflow-hidden bg-secondary/50 py-20 lg:py-28">
      <div aria-hidden="true" class="pointer-events-none absolute -top-24 right-0 size-[30rem] rounded-full bg-accent-soft/60 blur-3xl"></div>
      <div class="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div class="reveal mx-auto max-w-3xl text-center">
          <span class="text-xs font-semibold tracking-[0.2em] text-accent uppercase">Especialidades</span>
          <h2 class="mt-4 font-display text-4xl font-700 tracking-tight text-primary text-balance sm:text-5xl">Tratamentos para cada necessidade do seu sorriso</h2>
          <p class="mt-5 text-lg text-muted-foreground">Nossa força está na <strong class="font-semibold text-accent">Implantodontia</strong> e na <strong class="font-semibold text-accent">Periodontia</strong>, com um portfólio completo para cuidar de você por inteiro.</p>
        </div>

        <!-- Chips de navegação -->
        <div class="reveal mt-12 flex flex-wrap justify-center gap-2.5" role="tablist" aria-label="Especialidades">
          <?php foreach ($cfg['especialidades'] as $i => $s): ?>
            <button type="button" role="tab" data-esp-tab="<?= e($s['key']) ?>" aria-selected="<?= $i === 0 ? 'true' : 'false' ?>"
              ...
              <?= e($s['title']) ?>
              <?php if (!empty($s['featured'])): ?><span class="rounded-full bg-emerald/15 px-2 py-0.5 text-[0.62rem] font-bold tracking-wide text-emerald uppercase">Destaque</span><?php endif; ?>
            </button>
          <?php endforeach; ?>
        </div>
              ...
              <div class="grid items-stretch gap-8 overflow-hidden rounded-[2.5rem] border border-border bg-card shadow-[var(--shadow-soft)] lg:grid-cols-2">
                ...
                <div class="relative min-h-[280px] overflow-hidden <?= $i % 2 === 1 ? 'lg:order-2' : '' ?>">
                  ...
                  <?php if (!empty($s['featured'])): ?>
                    <span class="absolute top-5 left-5 inline-flex items-center gap-1.5 rounded-full bg-background/90 px-3.5 py-1.5 text-xs font-bold tracking-wide text-accent uppercase shadow-[var(--shadow-soft)] backdrop-blur"><?= icon('sparkles', 'size-3.5') ?>Especialidade em destaque</span>
                  <?php endif; ?>
                </div>
                <!-- Conteúdo -->
                <div class="flex flex-col justify-center p-8 lg:p-12">
                  ...
                  <h3 class="mt-6 font-display text-3xl font-700 tracking-tight text-primary"><?= e($s['title']) ?></h3>
                  ...
                  <a href="<?= e(whats($cfg, 'Olá! Gostaria de saber mais sobre ' . $s['title'] . ' na Clínica Odontológica Modelo.')) ?>" target="_blank" rel="noopener noreferrer" class="mt-8 inline-flex w-fit items-center gap-2 rounded-full bg-accent px-6 py-3.5 text-sm font-semibold text-accent-foreground shadow-[var(--shadow-soft)] transition-transform hover:scale-[1.03]">
                    <?= icon('message-circle', 'size-4') ?>Falar no WhatsApp sobre <?= e($s['title']) ?>
                  </a>
                </div>
              </div>
            </div>
    ...
    <section id="processo" class="relative overflow-hidden py-20 lg:py-28" style="background: var(--gradient-deep)">
      <div aria-hidden="true" class="pointer-events-none absolute -bottom-40 -right-32 size-[36rem] rounded-full bg-emerald/10 blur-3xl"></div>
      <div class="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div class="reveal mx-auto max-w-2xl text-center">
          <span class="text-xs font-semibold tracking-[0.2em] text-emerald uppercase">Como funciona</span>
          <h2 class="mt-4 font-display text-4xl font-700 tracking-tight text-white text-balance sm:text-5xl">Um processo claro do início ao fim</h2>
          <p class="mt-5 text-lg text-white/60">Um caminho simples e tranquilo, com você no centro de cada decisão.</p>
        </div>
          ...
          <?php foreach ($cfg['jornada'] as $i => $p): ?>
            <li class="reveal group relative" style="transition-delay:<?= $i * 90 ?>ms">
              <?php if ($i < count($cfg['jornada']) - 1): ?>
                <span aria-hidden="true" class="absolute top-7 left-[calc(50%+2.5rem)] hidden h-px w-[calc(100%-3rem)] bg-gradient-to-r from-emerald/40 to-transparent md:block"></span>
              <?php endif; ?>
              <div class="relative flex flex-col items-center text-center md:items-start md:text-left">
                <span class="grid size-14 place-items-center rounded-2xl border border-white/15 bg-white/5 text-emerald backdrop-blur transition-all duration-300 group-hover:scale-110 group-hover:border-emerald/50"><?= icon($p['icon'], 'size-6') ?></span>
                <span class="mt-4 font-display text-sm font-700 tracking-widest text-emerald/70"><?= e($p['n']) ?></span>
    ...
    <section id="sobre" class="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
      <div class="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
        <div class="reveal lg:col-span-5">
          <div class="relative">
            <div class="overflow-hidden rounded-[2.5rem] shadow-[var(--shadow-lift)]">
              <img src="img/sobre-clinica.svg" alt="Ambiente da Clínica Odontológica Modelo" loading="lazy" width="900" height="1080" class="h-full w-full object-cover" />
            </div>
            <div class="absolute -right-4 -bottom-6 rounded-2xl border border-border bg-background px-6 py-5 text-center shadow-[var(--shadow-lift)] sm:-right-8">
              <div class="font-display text-3xl font-700 text-accent"><?= e($cfg['rating']) ?><span class="text-emerald">★</span></div>
        ...
        <div class="reveal lg:col-span-6 lg:col-start-7" style="transition-delay:100ms">
          ...
          <h2 class="mt-4 font-display text-4xl font-700 tracking-tight text-primary text-balance sm:text-5xl"><?= e($cfg['sobre_titulo']) ?></h2>
          ...
          <dl class="mt-9 grid grid-cols-3 gap-5 border-t border-border pt-8">
            <?php foreach ($cfg['sobre_stats'] as $s): ?>
              <div>
                <dt class="font-display text-3xl font-700 text-primary"><?= e($s['v']) ?></dt>
      ...
      <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <div class="grid gap-8 lg:grid-cols-12 lg:items-end">
          <div class="reveal lg:col-span-6">
            ...
            <h2 class="mt-4 font-display text-4xl font-700 tracking-tight text-primary text-balance sm:text-5xl">Um ambiente feito para o seu conforto</h2>
          </div>
    ...
    <section id="depoimentos" class="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
      <div class="reveal flex flex-col items-center gap-6 text-center">
        ...
        <h2 class="max-w-2xl font-display text-4xl font-700 tracking-tight text-primary text-balance sm:text-5xl">Histórias de quem já confia na clínica</h2>
        <div class="inline-flex items-center gap-3 rounded-full border border-border bg-background px-5 py-3 shadow-[var(--shadow-soft)]">
          <span class="flex gap-0.5 text-emerald"><?php for($k=0;$k<5;$k++) echo icon('star','size-4 fill-emerald'); ?></span>
      ...
      <div class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <?php foreach ($cfg['depoimentos'] as $i => $t): ?>
          <figure class="reveal surface-card flex flex-col p-7" style="transition-delay:<?= ($i % 3) * 70 ?>ms">
            <?= icon('quote', 'size-8 text-emerald/40') ?>
            ...
            <figcaption class="mt-6 flex min-w-0 items-center gap-3 border-t border-border pt-5">
              <span class="grid size-11 shrink-0 place-items-center rounded-full font-display text-sm font-600 text-accent-foreground" style="background: var(--gradient-emerald)"><?= e($t['initials']) ?></span>
              <span class="min-w-0">
              ...
              <span class="ml-auto flex gap-0.5 text-emerald"><?php for($k=0;$k<5;$k++) echo icon('star','size-3 fill-emerald'); ?></span>
            </figcaption>
          </figure>
        <?php endforeach; ?>
      </div>
    ...
    <!-- CTA -->
    <section class="mx-auto max-w-7xl px-5 pb-20 lg:px-8 lg:pb-24">
      <div class="reveal relative overflow-hidden rounded-[2.5rem] px-6 py-16 text-center shadow-[var(--shadow-lift)] lg:px-16 lg:py-24" style="background: var(--gradient-deep)">
        <div aria-hidden="true" class="pointer-events-none absolute -top-24 -left-16 size-96 rounded-full bg-emerald/15 blur-3xl"></div>
        ...
        <div class="relative mx-auto max-w-2xl">
          <span class="flex justify-center gap-0.5 text-emerald"><?php for($k=0;$k<5;$k++) echo icon('star','size-5 fill-emerald'); ?></span>
          <h2 class="mt-6 font-display text-4xl font-700 tracking-tight text-white text-balance sm:text-5xl"><?= e($cfg['cta_titulo']) ?></h2>
          ...
          <a href="<?= e($waLink) ?>" target="_blank" rel="noopener noreferrer" class="mt-10 inline-flex items-center gap-3 rounded-full bg-accent px-9 py-5 text-lg font-semibold text-accent-foreground shadow-[var(--shadow-lift)] transition-transform hover:scale-[1.04]">
            <?= icon('message-circle', 'size-6') ?>Conversar no WhatsApp
          </a>
      ...
      <div class="overflow-hidden rounded-[2.5rem] border border-border shadow-[var(--shadow-soft)]">
        <div class="grid lg:grid-cols-[0.85fr_1.15fr]">
          <div class="reveal bg-card p-8 lg:p-12">
            ...
            <h2 class="mt-4 font-display text-3xl font-700 tracking-tight text-primary sm:text-4xl">Fácil de chegar, em <?= e($cfg['district']) ?></h2>
            <ul class="mt-8 space-y-6 text-sm">
              <li class="flex gap-4">
                ...
                <span class="text-muted-foreground">Rua Exemplo, 000 · 1º Andar<br /><?= e($cfg['district']) ?><br /><?= e($cfg['city']) ?> - <?= e($cfg['state']) ?></span>
              </li>
              <li class="flex gap-4">
  ...
  <footer class="relative overflow-hidden text-white" style="background: var(--gradient-deep)">
    <div class="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
      <div class="sm:col-span-2 lg:col-span-1">
        ...
        <p class="mt-4 max-w-xs text-sm leading-relaxed text-white/60">Dentista em Centro, Cidade Exemplo. Referência em implantodontia e periodontia, com atendimento moderno e humanizado.</p>
        <div class="mt-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs">
          <span class="flex gap-0.5 text-emerald"><?php for($k=0;$k<5;$k++) echo icon('star','size-3 fill-emerald'); ?></span>
          <span class="text-white/80"><?= e($cfg['rating']) ?> · <?= e($cfg['reviews']) ?> avaliações</span>
        </div>
      </div>
      <div>
        <h3 class="text-sm font-semibold text-white">Especialidades</h3>
        <ul class="mt-4 space-y-2.5 text-sm text-white/60">
          <?php foreach (array_slice($cfg['especialidades'], 0, 7) as $s): ?>
            <li><a href="#especialidades" class="transition-colors hover:text-emerald"><?= e($s['title']) ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div>
        ...
        <ul class="mt-4 space-y-2.5 text-sm text-white/60">
          <li><a href="tel:<?= e($cfg['phone_raw']) ?>" class="transition-colors hover:text-emerald">Telefone: <?= e($cfg['phone']) ?></a></li>
          <li><a href="<?= e($waLink) ?>" target="_blank" rel="noopener noreferrer" class="transition-colors hover:text-emerald">WhatsApp: <?= e($cfg['phone']) ?></a></li>
          <li class="pt-1 leading-relaxed">Rua Exemplo, 000 · 1º Andar<br /><?= e($cfg['district']) ?> · <?= e($cfg['city']) ?> - <?= e($cfg['state']) ?></li>
        </ul>
      </div>
      <div>
